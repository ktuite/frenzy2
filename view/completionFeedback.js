...
function goalSetup(){
	var goalDescription
	if (sessionMaking) {
		goalDescription = "<b>Goal:</b><br>Every face needs to be in a category."
	} else {
	    ...
	    goalDescription = "<b>Goal1:</b>  Every category must have at least 2 faces in it. (No singleton categories)<br/>" +
						"<b>Goal2:</b>  Every face needs to be in least one category with +1 for cluster-making potential."
	}
